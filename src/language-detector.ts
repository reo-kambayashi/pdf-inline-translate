...
export class LanguageDetector {
  ...
  private static analyzeCommonWords(text: string): Record<string, number> {
    ...
    const commonWords: Record<string, string[]> = {
      ...
      'es': ['el', 'la', 'de', 'que', 'y', 'a', 'en', 'un', 'es', 'se', 'no', 'te', 'lo', 'le', 'da', 'si', 'me', 'ya', 'por', 'qué'],
      'fr': ['le', 'de', 'et', 'à', 'un', 'il', 'être', 'et', 'en', 'avoir', 'que', 'pour', 'dans', 'je', 'son', 'ce', 'la', 'ne', 'sur', 'se'],
      'de': ['der', 'die', 'und', 'in', 'den', 'von', 'zu', 'das', 'nicht', 'sie', 'ist', 'des', 'es', 'ein', 'eine', 'f체r', 'auch', 'sich', 'auf', 'so'],
      'it': ['il', 'di', 'e', 'la', 'che', 'per', 'una', 'in', 'il', 'da', 'con', 'non', 'sono', 'che', 'il', 'del', 'le', 'il', 'si', 'ci'],
      'pt': ['o', 'de', 'a', 'e', 'do', 'da', 'em', 'um', 'para', 'foi', 'com', 'não', 'uma', 'os', 'no', 'se', 'na', 'por', 'mais', 'as'],
    };
