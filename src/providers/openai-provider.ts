...
export class OpenAITranslationProvider extends BaseTranslationProvider implements TranslationProvider {
    ...
    try {
      ...
      const requestBody = {
        ...
        messages: [
          {
            role: "system",
            content: "You are a professional translator. Translate the user's text accurately while preserving formatting."
          },
          {
            role: "user",
            content: prompt
